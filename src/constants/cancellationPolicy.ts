    ...
    sections: [
        {
            ...
            content: `The purpose of this Policy is to clearly define the circumstances under which services may be cancelled, the process for requesting cancellation, and the legal and financial consequences that arise as a result of cancellation. This Policy applies to all service engagements, including but not limited to one-time projects, ongoing service contracts, retainers, subscriptions, consulting arrangements, advisory services, pilot projects, and phased or milestone-based services.`
        },
        {
            title: "2. DEFINITIONS",
            content: `“Cancellation” means the termination of services prior to completion of the agreed scope of work.
“Commencement of Services” means the point at which any planning, preparation, consultation, resource allocation, research, advisory work, or system access begins.
“Written Notice” means a formal communication submitted via email or another documented medium capable of record retention.`
        },
        {
...
If cancellation occurs after commencement of services, no refunds shall be issued. All payments made remain non-refundable and any outstanding invoices become immediately due.`
        ...
        {
            title: "5. SUBSCRIPTION AND RETAINER SERVICES",
            content: `For subscription or retainer-based services, cancellation prevents future billing only. No refunds are issued for partially used billing periods. Services remain active until the end of the current billing cycle unless otherwise agreed in writing.`
        },
        {
        ...
        },
        {
            ...
            content: `All third-party costs incurred on behalf of the Client remain non-refundable and are the Client’s responsibility.`
        },
        {
            title: "9. FORCE MAJEURE",
            content: `Events beyond reasonable control do not entitle the Client to refunds or compensation.`
        },
        {
            title: "10. SURVIVAL",
            content: `Payment obligations, confidentiality, intellectual property rights, and liability limitations survive cancellation.`
        },
        {
            title: "11. MODIFICATIONS",
            content: `This Policy may be updated at any time. The version in effect at the time of engagement shall apply.`
        },
        {
            title: "12. CONTACT",
            content: `All cancellation-related communications must be sent to:
