...
Due to this nature, refunds are inherently limited once services are initiated.`
        ...
        },
        {
            ...
            content: `For the purposes of this Policy, work is deemed to have commenced when any planning, research, strategy development, consultation, internal discussion, account setup, tool configuration, or resource allocation begins. Once work has commenced, no refunds shall be issued.`
        },
        {
        ...
        },
        {
            ...
            content: `Any third-party costs incurred on behalf of the Client, including advertising spend, software subscriptions, licensing fees, or platform charges, are non-refundable.`
        },
        {
            title: "7. SUBSCRIPTIONS AND RETAINERS",
            content: `For subscription-based or retainer services, payments are billed in advance. Cancellation prevents future billing only. No refunds or prorated credits are issued for unused time.`
        },
        {
            title: "8. PAYMENT DISPUTES AND CHARGEBACKS",
            content: `Clients must raise payment concerns in writing before initiating disputes or chargebacks. Unauthorized chargebacks may result in immediate service termination and permanent denial of future services.`
        },
        {
            title: "9. FRAUD AND MISUSE",
            content: `No refunds shall be issued where fraud, misrepresentation, abuse, or breach of agreement is identified.`
        },
        {
            title: "10. FORCE MAJEURE",
            content: `Delays or non-performance caused by events beyond reasonable control do not entitle the Client to refunds or compensation.`
        },
        {
        ...
        },
        {
            ...
            content: `Approved refunds, if any, are processed in the original currency. Transaction and processing fees may be deducted.`
        },
        {
            title: "13. LEGAL COMPLIANCE",
            content: `Nothing in this Policy limits statutory rights that cannot be excluded under applicable law.`
        },
        {
        ...
        {
            title: "15. CONTACT",
            content: `All refund-related requests must be submitted in writing to:
