...
const YOUTUBE_ADS: IServiceType = {
  slug: "youtube-ads",
  title: "YouTube Ads",
  sections: [
    {
    ...
    },
    {
      ...
      data: {
        ...
        subheading: "{Results} from our YouTube advertising workflows",
        items: [
          { value: "390+", label: "YouTube Campaigns Launched", icon: "/icons/rocket.svg" },
          { value: "2–5 Days", label: "Avg. Campaign Setup Time", icon: "/icons/zap.svg" },
          { value: "97%", label: "Client Profitability Rate", icon: "/icons/shield-check.svg" },
          { value: "4.6x", label: "Avg. Return on Ad Spend (ROAS)", icon: "/icons/trending-up.svg" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          "E-commerce & D2C brands launching {products}",
          "Coaches & educators selling high-ticket programs",
          "SaaS & app developers driving installs & demos",
          "Real estate, finance & education advertisers",
          "Brands building long-term video-based {authority}",
        ],
      },
    },
    {
      ...
      data: {
        ...
        items: [
          "Google Ads Manager & YouTube Studio",
          "GA4, Google Tag Manager & conversion tracking",
          "Audience planner & intent-mapping tools",
          "Creative performance analytics platforms",
          "Funnel tracking & attribution dashboards",
        ],
      },
    },
    {
        ...
        plans: [
          {
            name: "Starter",
            price: "$349 – $599",
            description: "Account setup, tracking & basic YouTube ad launch.",
          },
          {
            name: "Standard",
            price: "$899 – $1,499",
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          {
            q: "Do I need professional video ads to run YouTube campaigns?",
            a: "Not always. UGC-style and simple educational videos also perform extremely well.",
          },
          {
            q: "Can YouTube Ads generate direct sales?",
            a: "Yes, especially when combined with remarketing and strong landing pages.",
          },
          {
            q: "Will YouTube Ads help my other ad platforms perform better?",
            a: "Yes, video awareness significantly improves Meta & Search conversion rates.",
          },
          {
            q: "How soon will I start seeing results?",
            a: "Views and traffic start immediately. Profitable performance usually stabilizes within 2–4 weeks.",
          },
        ],
      },
    },
