  ...
  sections: [
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          "Hero section explaining structured growth {planning}",
          "Platform-wise strategy breakdown (Instagram, LinkedIn, TikTok, YouTube)",
          "Content pillar & audience persona mapping visuals",
          "Funnel-based content planning examples",
          "Hook, storytelling & CTA strategy {examples}",
          "Competitor content & growth gap analysis previews",
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          ...
          "Target audience & content persona mapping",
          "Platform-wise social media growth strategy",
          "Content pillars & theme breakdown",
          "Reels, shorts & video content {strategy}",
          "Hashtag & discoverability strategy",
          "Monthly content calendar framework",
          "Engagement & community-building strategy",
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          "Eliminates guesswork from content {creation}",
          "Builds consistent brand authority & credibility",
          "Increases organic reach & engagement",
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          "Startups building organic brand {presence}",
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          "Platform analytics & trend-mapping tools",
