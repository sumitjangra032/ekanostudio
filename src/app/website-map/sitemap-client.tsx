...
export default function SitemapPageClient() {
    ...
    return (
        <main
            className="min-h-screen w-full pt-32 pb-20 px-6 bg-[var(--theme-background)]"
        >
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-20">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold mb-4 text-[var(--theme-text)] font-general-sans">
                        <AnimatedLine
                    ...
                    <p className="text-lg max-w-2xl mx-auto text-[var(--theme-subtext)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {renderData.map((section, idx) => (
                        ...
                        >
                            {/* Left Accent Line */}
                            <div className="absolute left-0 top-0 h-full w-[2px] bg-gradient-to-b from-transparent via-[var(--theme-accent-a)] to-transparent" />

                            <h2 className="text-xl font-bold mb-6 flex items-center gap-3 text-[var(--theme-text)]">
                                {section.category}
                            </h2>
                            ...
                            <ul className="space-y-3">
                                {section.links.map((link, lIdx) => (
                                    <li key={lIdx}>
                                        <Link
                                            href={link.href}
                                            className="group flex items-start gap-2 text-sm transition-all duration-300 hover:translate-x-2 underline decoration-blue-400/30 underline-offset-4 decoration-1 hover:decoration-blue-400 text-[var(--theme-subtext)]"
                                        >
