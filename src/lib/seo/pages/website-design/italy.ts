...
export const data: SeoPageData = {
    ...
    meta: {
        ...
        description: "Premium web design for the Italian market. We combine Italian design excellence with cutting-edge technology to build high-converting websites.",
        canonical: "/website-design-italy",
    },
    content: {
        hero: {
            title: "Eccellenza Digitale per il Mercato Italiano",
            subtitle: "Uniamo lo stile italiano all'innovazione tecnologica per creare siti web che lasciano il segno.",
        },
        overview: {
        ...
        whyChoose: {
            ...
            points: [
                { title: "Design Made in Italy", desc: "Estetica raffinata che risuona con il gusto e la cultura italiana." },
                { title: "Ottimizzazione Mobile", desc: "Siti perfettamente fruibili da smartphone, come richiesto dagli utenti italiani." },
                { title: "Conformità GDPR", desc: "Siti sicuri e pronti per le normative europee sulla privacy." }
            ]
        },
        deliverables: [
