...
export const data: SeoPageData = {
    ...
    meta: {
        ...
        description:
            "Rank higher in Delhi NCR. Our SEO team specializes in competitive industries such as real estate, healthcare, finance, education, and corporate sectors in Delhi.",
